...
<script>
  ...
  <div class="right-side">
    <div class="box-topic">Today Expenses</div>
 ...
 <!-- yesterday expenses Box-->


        <div class="box">
          <div class="right-side">
            <div class="box-topic">Yesterday Expenses</div>
  ...
  <!-- MONTH expense Box -->
        <div class="box">
          <div class="right-side">
            <div class="box-topic">Last 30days Expenses</div>
          ...
          echo $sum_monthly_expense;
            ...
            <div class="indicator">
              <i class='bx bx-up-arrow-alt'></i>
              <span class="text">Up from Last 30 days</span>
            </div>
          </div>
    ...
    <table class="table">
      ...
      <tfoot>
        <tr>
          <th></th>
          <th>Total</th>
          <th>RWF  <span id="total-expense"></span></th>
        </tr>
      </tfoot>
    </table>
  </div>
    ...
    const rows = data.map((item, i) => {
      ...
      return `
        <tr>
          ...
          <td>${item.category}</td>
          <td>RWF  ${item.total_expense.toFixed(2)}</td>
        </tr>
      `;
    }).join('');
