...
if (strlen($_SESSION['detsuid']==0)) {
  header('location:logout.php');
    ...
    if (isset($_GET['delid'])) {
        ...
        $query = mysqli_query($db, "DELETE FROM income WHERE ID='$rowid'");
        if ($query) {
      ...
      <ul class="nav-links">
       ...
       <li>
          <a href="manage-expenses.php">
            ...
            <span class="links_name">Manage Expenses</span>
          </a>
        </li>
        <li>
          <a href="income.php">
        ...
        <li>
         ...
         <span class="links_name">Manage income</span>
          </a>
        </li>
        <li>
      ...
      window.location.href = window.location.pathname + '?' + urlParams.toString(); // Reload page with new query parameters
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $offset = ($page - 1) * $limit;
                                        $ret=mysqli_query($db,"select * from income where UserId='$userid' LIMIT $limit OFFSET $offset");
                                        $cnt = $offset + 1;
                                        ...
                                        ?>
                                          ...
                                          <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton<?php echo $row['id']; ?>">
                                              ...
                                              <a class="dropdown-item" href="manage-income.php?delid=<?php echo $row['id']; ?>"><i class="fas fa-trash-alt"></i> Delete</a>
                                            </div>
                                          </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="update-income.php" method="POST">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="edit-expense-date">Date of income:</label>
                                                            <input type="date" class="form-control" id="edit-expense-date" name="date_of_income" value="<?php echo $row['date_of_income']; ?>">
                                                        </div>
                                                        <div class="form-group">
                            ...
                            <?php
                            $result = mysqli_query($db, "SELECT COUNT(ID) as total FROM income ");
