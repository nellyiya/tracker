...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $sql = "INSERT INTO income (name,UserId, date_of_income, amount, description, status) VALUES ('$name','$userid' ,'$date_of_income', $amount, '$description', '$status')";
  if (mysqli_query($conn, $sql)) {
    echo '<script type="text/javascript">alert("New income record created successfully");</script>';
    echo " <script type='text/javascript'>window.location.href = 'manage-income.php';</script>";
